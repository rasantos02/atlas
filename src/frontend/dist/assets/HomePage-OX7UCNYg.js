import { j as jsxRuntimeExports, c as cn, R as React2, r as reactExports, v as vt, G as Globe, S as Skeleton, C as Clock } from "./index-BiNIKcBE.js";
import { B as Badge } from "./index-8fijkRIb.js";
import { B as Button, I as Input } from "./input-S0QbCADB.js";
import { P as Plane, C as CalendarDays, D as Dialog, a as DialogTrigger, b as Plus, c as DialogContent, d as DialogHeader, e as DialogTitle, L as Label, T as Textarea, f as format } from "./format-CR2xzuvR.js";
import { C as COUNTRY_BY_CODE, a as COUNTRIES_PER_CONTINENT, b as COUNTRIES } from "./countries-Cpa9FtoK.js";
import { u as useGetStats, a as useListCountries, b as useListTrips, T as TravelStatus, c as useSetCountry, d as useAddTrip } from "./use-travel-CZZKui9J.js";
...
function bigintToDate(ts) {
  return new Date(Number(ts / 1000000n));
}
function dateToBigint(d) {
...
function StatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5", children: label }),
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-16" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold text-foreground", children: value })
    ] }),
...
function ContinentCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/30 rounded-xl p-4 border border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground font-display", children: continent }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-amber-400", children: [
        pct,
        "%"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-1.5 rounded-full bg-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
...
function TripRow({
  ...
  const name = (country == null ? void 0 : country.name) ?? countryCode;
  const flag = (country == null ? void 0 : country.flag) ?? "🌍";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl leading-none shrink-0", children: flag }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: [
            formatDate(startDate),
            " → ",
            formatDate(endDate)
          ] }),
          notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 truncate mt-0.5", children: notes })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plane, { className: "w-3 h-3 mr-1" }),
              "Trip"
            ]
          }
        )
...
function AddCountryDialog() {
  ...
  const [status, setStatus] = reactExports.useState(TravelStatus.visited);
  const [startDate, setStartDate] = reactExports.useState("");
  const [endDate, setEndDate] = reactExports.useState("");
  const [notes, setNotes] = reactExports.useState("");
  const [step, setStep] = reactExports.useState("country");
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      ue.success(`${selectedCountry.flag} ${selectedCountry.name} added!`);
      setOpen(false);
      handleReset();
    } catch {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-lg", children: step === "country" ? "Choose a Country" : `Add ${selectedCountry == null ? void 0 : selectedCountry.flag} ${selectedCountry == null ? void 0 : selectedCountry.name}` }) }),
              step === "country" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 mt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-72 overflow-y-auto space-y-0.5 pr-1", children: filtered.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-muted-foreground", children: c.continent })
                    ]
                  },
                  c.iso2
                )) })
              ] }),
              step === "details" && selectedCountry && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mt-2", children: [
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        className: cn(
                          ...
                          status === s ? cn(cfg.bg, cfg.border, cfg.color) : "border-border text-muted-foreground hover:border-border hover:bg-muted/30"
                        ),
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(cfg.icon, { className: "w-4 h-4" }),
                          cfg.label
                        ]
                      },
                      s
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Start Date (optional)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "End Date (optional)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
...
function HomePage() {
  ...
  const continentVisitedCounts = reactExports.useMemo(() => {
    const map = {};
    for (const entry of countries) {
      if (entry.status !== TravelStatus.visited && entry.status !== TravelStatus.lived_in)
        continue;
  ...
  const recentTrips = reactExports.useMemo(() => {
    return [...trips].sort((a, b) => Number(b.startDate - a.startDate)).slice(0, 5);
  }, [trips]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-7 max-w-5xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Your world at a glance" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AddCountryDialog, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Travel statistics", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          label: "Countries Visited",
          value: isLoading ? "—" : stats ? Number(stats.totalVisited) : visitedCount,
          icon: MapPin,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Lived In",
          value: isLoading ? "—" : stats ? Number(stats.totalLivedIn) : livedCount,
          icon: House,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Wishlisted",
          value: isLoading ? "—" : stats ? Number(stats.totalWishlisted) : wishlistedCount,
          icon: Heart,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Total Trips",
          value: isLoading ? "—" : stats ? Number(stats.totalTrips) : trips.length,
          icon: Plane,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Continents explored", className: "lg:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card h-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: Array.from({ length: 6 }, (_, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: static skeleton list
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-xl" }, i)
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: DISPLAY_CONTINENTS.map((continent) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ContinentCard,
          {
            continent,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card h-full", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: tripsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: Array.from({ length: 4 }, (_, i) => (
              // biome-ignore lint/suspicious/noArrayIndexKey: static skeleton list
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 rounded-lg" }, i)
            )) }) : recentTrips.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": "recent_trips.empty_state",
                className: "flex flex-col items-center justify-center py-10 text-center gap-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plane, { className: "w-5 h-5 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No trips yet" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Add a country to log your first trip" })
                  ] })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: recentTrips.map((trip, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              TripRow,
              {
    ...
    countries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "aria-label": "Countries by status", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border bg-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(cfg.icon, { className: cn("w-3.5 h-3.5", cfg.color) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: cn(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: list.map((entry) => {
            const meta = COUNTRY_BY_CODE.get(entry.code);
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                title: (meta == null ? void 0 : meta.name) ?? entry.code,
                className: cn(
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: (meta == null ? void 0 : meta.flag) ?? "🌍" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: (meta == null ? void 0 : meta.name) ?? entry.code })
                ]
              },
              entry.code
            );
    ...
    !isLoading && countries.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-7 h-7 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-foreground", children: "Start your atlas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1 max-w-xs mx-auto", children: "Track every country you've visited, lived in, or dream of exploring." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AddCountryDialog, {})
        ] })
      }
