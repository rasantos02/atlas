import { a as createLucideIcon, r as reactExports, j as jsxRuntimeExports, C as Clock, G as Globe, S as Skeleton } from "./index-BiNIKcBE.js";
import { b as useListTrips, a as useListCountries, u as useGetStats, d as useAddTrip, h as useUpdateTrip, i as useDeleteTrip, T as TravelStatus } from "./use-travel-CZZKui9J.js";
import { B as Badge } from "./index-8fijkRIb.js";
import { B as Button, I as Input } from "./input-S0QbCADB.js";
import { P as Plane, b as Plus, D as Dialog, c as DialogContent, d as DialogHeader, e as DialogTitle, L as Label, T as Textarea, C as CalendarDays, f as format } from "./format-CR2xzuvR.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-Bv3iV3dN.js";
import { b as COUNTRIES, C as COUNTRY_BY_CODE } from "./countries-Cpa9FtoK.js";
...
function msToDateStr(ms) {
  return format(new Date(Number(ms / 1000000n)), "yyyy-MM-dd");
}
function dateStrToMs(str) {
  return BigInt(new Date(str).getTime());
}
function displayDate(ms) {
  return format(new Date(Number(ms / 1000000n)), "MMM d, yyyy");
}
function getYear(ms) {
  return new Date(Number(ms / 1000000n)).getFullYear();
}
function tripDays(trip) {
  const startMs = Number(trip.startDate / 1000000n);
  const endMs = Number(trip.endDate / 1000000n);
  return Math.max(1, Math.ceil((endMs - startMs) / 864e5));
}
const STATUS_LABELS = {
...
const STATUS_CLASSES = {
  ...
  [TravelStatus.wishlisted]: "border-yellow-500/40 bg-yellow-500/10 text-yellow-400"
};
const DOT_CLASSES = {
...
function StatPill({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-card border border-border rounded-lg px-3 py-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-4 h-4 text-primary shrink-0", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-wider text-muted-foreground font-medium", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-foreground mt-0.5", children: value })
    ] })
  ] });
}
function TripCard({
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `absolute left-[14px] top-5 w-3 h-3 rounded-full border-2 border-background z-10 transition-smooth ${status ? DOT_CLASSES[status] : "bg-primary"}`,
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-4 hover:border-primary/30 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl shrink-0 leading-none", "aria-hidden": "true", children: (meta == null ? void 0 : meta.flag) ?? "🌍" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground", children: (meta == null ? void 0 : meta.name) ?? trip.countryCode }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-3 h-3", "aria-hidden": "true" }),
              ...
              trip.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1.5 italic leading-relaxed line-clamp-2", children: [
                "“",
                trip.notes,
                "”"
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0 opacity-0 group-hover:opacity-100 transition-smooth", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                className: "h-7 w-7",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "w-3.5 h-3.5", "aria-hidden": "true" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-3.5 h-3.5", "aria-hidden": "true" })
              }
            )
          ] })
        ] }) })
...
function YearSeparator({ year }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "aria-hidden": "true",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-[14px] top-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-background border-2 border-border flex items-center justify-center z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xs font-bold text-muted-foreground tracking-widest uppercase", children: year }),
...
function FilterBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 px-8 py-3 border-b border-border bg-background/80 backdrop-blur-sm sticky top-[65px] z-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: yearFilter, onValueChange: onYear, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SelectTrigger,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [
      ...
      "button",
      {
        ...
        className: `px-2.5 py-1 rounded-md text-xs font-medium transition-smooth ${statusFilter === value ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
        children: label
      },
      value
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownUp, { className: "w-3 h-3", "aria-hidden": "true" }),
...
function TimelinePage() {
  ...
  const countryStatusMap = reactExports.useMemo(() => {
  ...
  const filteredTrips = reactExports.useMemo(() => {
    ...
    list.sort(
      (a, b) => sortOrder === "desc" ? Number(b.startDate) - Number(a.startDate) : Number(a.startDate) - Number(b.startDate)
    );
    return list;
  }, [trips, yearFilter, statusFilter, sortOrder, countryStatusMap]);
  const timelineItems = reactExports.useMemo(() => {
    const items = [];
    let lastYear = null;
    let idx = 0;
  ...
  async function handleDelete(id2) {
    await deleteTrip.mutateAsync(id2);
  }
  const isSubmitting = addTrip.isPending || updateTrip.isPending;
  const totalTrips = stats ? Number(stats.totalTrips) : (trips == null ? void 0 : trips.length) ?? 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground leading-none", children: "Timeline" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Your travel history" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StatPill,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                className: "gap-2 h-9",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4", "aria-hidden": "true" }),
                  "Add Trip"
                ]
              }
            )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-8 py-8", children: tripsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "timeline.loading_state", className: "space-y-4", children: Array.from({ length: 5 }, (_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: static skeleton list, order never changes
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-14", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-xl" }) }, i)
    )) }) : filteredTrips.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg mb-1", children: (trips == null ? void 0 : trips.length) === 0 ? "No trips yet" : "No trips match your filters" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-5 max-w-xs", children: (trips == null ? void 0 : trips.length) === 0 ? "Start logging your adventures to build your Atlas." : "Try adjusting the year or status filters above." }),
          (trips == null ? void 0 : trips.length) === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "button",
              onClick: openAdd,
              "data-ocid": "timeline.empty.add_button",
              children: "Add your first trip"
            }
          )
        ]
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: timelineItems.map(
        (item) => item.type === "year" ? /* @__PURE__ */ jsxRuntimeExports.jsx(YearSeparator, { year: item.year }, `year-${item.year}`) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          TripCard,
          {
            trip: item.trip,
            index: item.displayIndex,
            countryStatus: countryStatusMap.get(item.trip.countryCode) ?? null,
            onEdit: openEdit,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { "data-ocid": "timeline.trip.dialog", className: "sm:max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: editing ? "Edit Trip" : "Log a Trip" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "trip-country", children: "Country" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "max-h-64", children: COUNTRIES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: c.iso2, children: [
                  c.flag,
                  " ",
                  c.name
                ] }, c.iso2)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "trip-start", children: "Start Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "trip-start",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "trip-end", children: "End Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "trip-end",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "trip-notes", children: [
            "Notes",
            " ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "submit",
              disabled: isSubmitting || !form.countryCode || !form.startDate || !form.endDate,
              "data-ocid": "timeline.trip.submit_button",
              children: isSubmitting ? "Saving…" : editing ? "Save Changes" : "Log Trip"
            }
          )
        ] })
      ] })
